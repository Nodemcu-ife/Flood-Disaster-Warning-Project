...
void setup()
{
  ...
  pinMode(floatswitch0,INPUT_PULLUP);
...
void loop()
{
  ...
  if(  int x = digitalRead(floatswitch4)){
    Serial.println(2.5);}
  else if ( int x = digitalRead(floatswitch3)){
    Serial.println(2.0);}
  else if ( int x = digitalRead(floatswitch2)){
    Serial.println(1.5);}
  else if ( int x = digitalRead(floatswitch1)){
    Serial.println(1.0);}
  else if ( int x = digitalRead(floatswitch0)){
    Serial.println(0.5);}
  else 
    Serial.println(0);
  //Serial.println("m");
